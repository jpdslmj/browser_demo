...
import com.ds.browser.util.IDockingController;
...
public class HistoryAdapter extends BaseExpandableListAdapter implements IDockingController {
    ...
    public HistoryAdapter(Context context, ExpandableListView listView, List<String> parentList, Map<String,List<HistoryItemBean>> mHistoryData){
