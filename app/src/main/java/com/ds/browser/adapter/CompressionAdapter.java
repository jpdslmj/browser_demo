...
public class CompressionAdapter extends BaseAdapter {
    private Context context;
    private List<Object> data;
    private SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.ENGLISH);

    public CompressionAdapter(Context context, List<Object> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListView.LayoutParams params = new ListView.LayoutParams(ListView.LayoutParams.MATCH_PARENT, AppUtil.dip2px(context, 65));//设置宽度和高度
