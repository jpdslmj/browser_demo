...
public class FileService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        listener=new SDCardListener("/storage/emulated/0/BrowserDownloads",this);
    }
    ...
    private static class SDCardListener extends FileObserver{
        private WeakReference<FileService> weakReference;

        SDCardListener(String path, FileService service) {
            /*
