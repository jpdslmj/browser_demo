...
import com.ds.browser.fragment.HistoryFragment;
import com.ds.browser.fragment.LabelFragment;
    ...
    private void initData(){
        ...
        labelHistoryViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position==0){
                    HistoryActivity.this.canSwipe(true);

                }
                else {
                    HistoryActivity.this.canSwipe(false);
                }
            }
