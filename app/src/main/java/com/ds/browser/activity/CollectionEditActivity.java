...
import com.ds.browser.util.PictureUtil;
import com.ds.browser.widget.CircleImageView;
        ...
        collectionEditConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editToCollection.isChecked()) {
                    BrowserDBHelper.getBrowserDBHelper(CollectionEditActivity.this).updateCollectionTable(PictureUtil.bitmapToBytes(icon),url,title);
                }
